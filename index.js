!(function (e, t) {
  "function" == typeof define && define.amd
    ? define(["rxjs", "rxjs/operators"], t)
    : "object" == typeof exports
    ? (module.exports = t(require("rxjs"), require("rxjs/operators")))
    : ((e.returnExports = t(e.rxjs, e.rxjs.operators)),
      (e.RxJsVisualizer = e.returnExports));
})(this, (e, t) => {
  const o = e,
    { Subject: n } = e;
  e.operators || (e.operators = t);
  const { concatMap: i, map: r, take: l, delay: s, share: a } = e.operators;
  class c {
    static register(e, t) {
  ...
  return {
    init: function (e) {
      try {
        void 0 !== typeof document && (w = document.getElementById(e.canvasId)),
          ...
          void 0 !== typeof document &&
            (m = document.getElementById(e.logDivId)),
          m ||
            (E("-------------------------------------------------------------"),
            E(
      ...
      S("**********************************************", "color:blue"),
        ...
        b.maxLogLength > 0 &&
          S(
            `limit log strings to ${b.maxLogLength} characters`,
            "color:orange"
          ),
        (u = { ...b.symbolMap }),
    ...
    createStreamFromArrayOnClick: function (e, t, o, i) {
      ...
      return (
        ...
        document
          .getElementById(o)
          .addEventListener("click", (e) => r.complete()),
    ...
    createStreamFromSubjectOnClick: function (e, t, o, n) {
      ...
      return (
        document
          .getElementById(t)
          .addEventListener("click", (t) => e.next(i++)),
        document
          .getElementById(o)
          .addEventListener("click", (t) => e.complete()),
        document
          .getElementById(n)
